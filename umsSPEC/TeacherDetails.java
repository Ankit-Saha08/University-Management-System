...
public class TeacherDetails extends JFrame implements ActionListener{
	...
	String x[] = {"Name", "Father's Name", "DOB", "Age", "Phone", "Email ID", "Class X(%)",
				  "Class XII(%)", "Emp ID", "Aadhar", "Dept.", "Course", "Address"};
	String y[][] = new String[50][13];

	public TeacherDetails() {
		super("SPEC - Teacher Details");
		ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("icons/icon4.jpg"));
		...
		lb1 = new JLabel("View Teacher Details");
		lb1.setSize(400, 30);
		...
		tbl.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent arg0){
				...
				ldtf.setText(tbl.getModel().getValueAt(row, 8).toString());
			}
		});
	...
	public void actionPerformed(ActionEvent e){
		String sql = "delete from teacher where emp_id = "+ldtf.getText();
		try{
			pst = C.prepareStatement(sql);
			pst.executeUpdate();
			
			JOptionPane.showMessageDialog(null, "Employee with id-"+ldtf.getText()+" deleted from Database");
			ldtf.setText("");
