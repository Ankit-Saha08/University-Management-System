...
public class New extends JFrame implements ActionListener{
	...
	public New() {
		...
		lb1 = new JLabel("!!! Choose to Add new Student / Faculty !!!");
		...
		btn1 = new JButton("New Student", new ImageIcon(imgicon1));
		...
		btn2 = new JButton("New Faculty", new ImageIcon(imgicon2));
