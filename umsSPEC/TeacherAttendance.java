...
public class TeacherAttendance extends JFrame implements ActionListener{
	...
	public TeacherAttendance(){
		super("SPEC - Teacher Attendance");
		ImageIcon icon = new ImageIcon(ClassLoader.getSystemResource("icons/icon17.png"));
	...
	public void actionPerformed(ActionEvent e){
		...
		if (e.getSource()==btn1){
			 ...
			 String sql1 = "insert into attendance_teacher values ('"+chc.getSelectedItem()+"', '"+
					 		date+"', '"+cfh.getSelectedItem()+"', '"+clh.getSelectedItem()+"')";
			 ...
			 JOptionPane.showMessageDialog(null, "Attendance of employee with\nid-"+chc.getSelectedItem()+" confirmed");
		}
